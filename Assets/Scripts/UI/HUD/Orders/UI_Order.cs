...
public class UI_Order : MonoBehaviour
{
    ...
    public void Init(Order order)
    {
        ...
        MissedOrdersContainer.GetComponent<TooltipTarget_Simple>().Text = $"You have failed to deliver {numMissedOrders} orders in a row this customer. You will lose the game when failing to deliver {Game.CUSTOMER_ORDER_MISSES_IN_A_ROW_TO_LOSE_GAME} orders in a row.";
    }
